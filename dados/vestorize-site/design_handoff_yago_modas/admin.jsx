...
const ADMIN_CREDS = { user: "yago", pass: "yago123" };
    ...
    <div className="login-wrap">
      <form className="login-card" onSubmit={submit}>
        ...
        <div className="login-hint">
          <b>Demonstração:</b> usuário <code>yago</code> · senha <code>yago123</code><br />
          <span>O login real (com banco de dados) será montado depois no Claude Code.</span>
        </div>
      </form>
    </div>
  );
    ...
    <div className="adm">
      <header className="adm-top">
        ...
        <div className="adm-top-actions">
          <a className="btn btn-ghost" href="Catálogo Yago Modas.html" target="_blank" rel="noreferrer">{A.ext()} Ver catálogo</a>
